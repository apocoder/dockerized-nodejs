...
curl -X DELETE -H "Content-Type: application/json" http://127.0.0.1:8081/v2/apps/app
sleep 1
...
curl -X POST -H "Content-Type: application/json" http://127.0.0.1:8081/v2/apps -d@app_marathon.json.tmp
